...
import com.sdy.domin.DimCategoryCompare2;
...
/**
 * @Package com.sdy.func.MaoOrderInfo
 * @Author danyu-shi
 * @Date 2025/5/15 9:29
 * @description:
 */
public class MaoOrderInfo extends RichMapFunction<JSONObject,JSONObject> {
    ...
    public MaoOrderInfo(List<DimBaseCategory2> dimBaseCategories, double deviceRate, double searchRate) {
    ...
    public void open(Configuration parameters) throws Exception {
        ...
        String sql = "select order_id ,base_category_name,base_trademark_name from gmall_v1_danyu_shi.cct;";
