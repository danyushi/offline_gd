 ...
 * @description: 布隆过滤器
 */
public class FilterBloomOrderInfolicatorFunc extends RichFilterFunction<JSONObject> {

    private static final Logger logger = LoggerFactory.getLogger(FilterBloomOrderInfolicatorFunc.class);

    private final int expectedInsertions;
    private final double falsePositiveRate;
    private transient ValueState<byte[]> bloomState;

    public FilterBloomOrderInfolicatorFunc(int expectedInsertions, double falsePositiveRate) {
